...
mod tests {
    ...
    const GOLDEN: [(u64, [&str; 8], &str); 3] = [
        (
            ...
            "7d46485fe905db5e4a0cdfdd8241671607dd68175a1b44321003c912f9763207",
        ),
        (
            3,
            [
            ...
            "68e0212b55d3bccc920f6be03c75ee585e537037a16614fe807819bdff286209",
        ),
        (
            7,
            [
            ...
            "f2edf554dfd497653d2d1a038016cbf309d3673da2c53698ad956b014fdd927c",
        ),
    ];
